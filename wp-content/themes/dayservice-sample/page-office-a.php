...
<section class="section" id="instagram">
    <div class="section-inner fade-in-up">
        <div class="section-header" style="margin-bottom: 2.5rem;">
            ...
            <div class="ig-header-qr">
                <a href="https://www.instagram.com/dayservice_tonbo/" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/instagram-qr.jpg" alt="Instagram QRコード @dayservice_tonbo" class="ig-qr-small">
                </a>
            </div>
        </div>
        ...
        <div class="ig-posts-grid">
            <div class="ig-post-wrapper">
                <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DWVoa8wgSrg/" data-instgrm-version="14" style="background:#FFF; border:0; margin: 0; padding:0; width:100%;"></blockquote>
                <div class="ig-post-overlay">
                    <a href="https://www.instagram.com/p/DWVoa8wgSrg/" target="_blank" rel="noopener noreferrer" class="ig-read-more">続きをみるにはコチラ</a>
                </div>
            </div>
            
            <div class="ig-post-wrapper">
                <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DWAkSdJAUrx/" data-instgrm-version="14" style="background:#FFF; border:0; margin: 0; padding:0; width:100%;"></blockquote>
                <div class="ig-post-overlay">
                    <a href="https://www.instagram.com/p/DWAkSdJAUrx/" target="_blank" rel="noopener noreferrer" class="ig-read-more">続きをみるにはコチラ</a>
                </div>
            </div>

            <div class="ig-post-wrapper">
                <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/reel/DOIN8V6AaBH/" data-instgrm-version="14" style="background:#FFF; border:0; margin: 0; padding:0; width:100%;"></blockquote>
                <div class="ig-post-overlay">
                    <a href="https://www.instagram.com/reel/DOIN8V6AaBH/" target="_blank" rel="noopener noreferrer" class="ig-read-more">続きをみるにはコチラ</a>
                </div>
            </div>
        </div>
    </div>
