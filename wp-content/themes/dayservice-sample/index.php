                ...
                <div class="office-card-body">
                    <ul class="office-info">
                        <li>
                            ...
                            <span>〒100-0001 東京都千代田区千代田1-1-1 サンプルビル1F</span>
                        </li>
                        <li>
                            <span class="info-label">電話</span>
                            <span><a href="tel:012-345-6789" style="color: inherit; text-decoration: none;">012-345-6789</a></span>
                        </li>
                        <li>
    ...
    <div class="section-inner fade-in-up">
        ...
        <div class="greeting-grid">
            ...
            <div class="greeting-text">
                ...
                <div class="message">
                    <p>
                        私どもサンプル株式会社のデイサービスをご覧いただき、誠にありがとうございます。
                    </p>
                    <br>
                    <p>
                        当デイサービスでは、「笑顔があふれる、もうひとつの我が家」をモットーに、
                        ご利用者様お一人おひとりに寄り添った温かいサービスを提供しております。
                    </p>
                    <br>
                    <p>
                        日常生活のサポートだけでなく、レクリエーションを通じた生きがいづくり、
                        そして何より「楽しい」と感じていただける場所でありたいと考えています。
                        スタッフ一同、皆さまの笑顔のために全力を尽くしてまいります。
                    </p>
                    <br>
                    <p>
                        介護についてのご不安やご相談がございましたら、どうぞお気軽にお問い合わせください。
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="section-inner fade-in-up">
        ...
        <table class="company-table">
            <tbody>
                ...
                <tr>
                    <th>所在地</th>
                    <td>〒100-0001 東京都千代田区千代田1-1-1 サンプルビル3F</td>
                </tr>
                <tr>
                    <th>電話番号</th>
