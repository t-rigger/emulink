                ...
                <div class="office-card-body">
                    <ul class="office-info">
                        <li>
                            ...
                            <span>〒462-0845 愛知県名古屋市北区柳原1-18-8 高野ビル1階</span>
                        </li>
                        <li>
                    ...
                    <div class="office-card-map" style="height: 150px; margin-top: 1rem; border-radius: 8px; overflow: hidden; position: relative; z-index: 2;">
                        <iframe src="https://maps.google.com/maps?q=愛知県名古屋市北区柳原1-18-8&z=15&output=embed" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    </div>
            ...
            <div class="office-card">
                ...
                <div class="office-card-body">
                    <ul class="office-info">
                        <li>
                            <span class="info-label">住所</span>
                            <span>〒453-0844 愛知県名古屋市中村区小鴨町66番地</span>
                        </li>
                        <li>
                            <span class="info-label">電話</span>
    ...
    <div class="section-inner fade-in-up">
        ...
        <table class="company-table">
            <tbody>
                ...
                <tr>
                    <th>所在地</th>
                    <td>〒461-0027 愛知県名古屋市東区芳野1-18-7</td>
                </tr>
                <tr>
                    <th>代表取締役</th>
                    <td>梶 瑞穂</td>
...
<section class="section" id="instagram">
    <div class="section-inner fade-in-up">
        <div class="section-header" style="margin-bottom: 2.5rem;">
            ...
            <div class="ig-header-qr">
                <a href="https://www.instagram.com/dayservice_tonbo/" target="_blank" rel="noopener noreferrer">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/instagram-qr.png" alt="Instagram QRコード @dayservice_tonbo" class="ig-qr-small">
                </a>
            </div>
        </div>
        ...
        <div class="ig-posts-grid">
            ...
            <div class="ig-post-wrapper">
                <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/DWAkSdJAUrx/" data-instgrm-version="14" style="background:transparent; border:0; margin: 0; padding:0; width:100%;"></blockquote>
                <div class="ig-post-overlay">
                    <a href="https://www.instagram.com/dayservice_tonbo" target="_blank" rel="noopener noreferrer" class="ig-read-more">続きをみるにはコチラ</a>
                </div>
            </div>
